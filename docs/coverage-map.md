...
| Cross-resource substitution | [Free-Riding], Context Binding (I3); [Five Attacks], binding | Bind nonce to the served resource (canonical key); `nonce-resource-mismatch` | [`test/attacks/cross-resource-substitution.test.ts`](../test/attacks/cross-resource-substitution.test.ts) (guarded suite) |
